...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { course_id: @batch.course_id, name: @batch.name, school_id: @batch.school_id } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { course_id: @batch.course_id, name: @batch.name, school_id: @batch.school_id } }
